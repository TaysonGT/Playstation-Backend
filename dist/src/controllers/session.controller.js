...
const endSession = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    if (session && cashier && cashier_id) {
        ...
        if (device) {
            ...
            const financeData = { finances: total, type: "Device",
            ...
            // TIME ORDERS RECEIPT
            const timeReceiptData = TimeReceiptRepo.create({ orders: JSON.stringify(orders), time_orders: JSON.stringify(timeOrders), total,
